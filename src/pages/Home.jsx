     ...
     <Col className='mb-5' sm={12} md={6} lg={4} xl={3}>
      ...
      <div className='d-flex justify-content-between align-items-center'>
         <Button style={{border:'none',fontSize:'30px'}} className='btn btn-light bg-transparent ' onClick={()=>dispatch(addToWishList(product))}> <i className='fa-solid fa-heart text-danger' variant></i></Button>
          <Button style={{border:'none',fontSize:'30px'}} onClick={()=>dispatch(addToCart(product))}  className='btn btn-light me-3 bg-transparent'> <i class="fa-solid fa-cart-plus text-success" varient></i></Button>
      </div>
      </Card.Body>
    </Card>
    </Col>
